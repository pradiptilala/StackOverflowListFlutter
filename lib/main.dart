...
class _MyHomePageState extends State<MyHomePage> {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return OrientationBuilder(
          builder: (context, orientation) => orientation == Orientation.portrait ? _buildVerticalLayout(posts[index]) : _buildHorizontalLayout(posts[index]),
        );
        // return _buildVerticalLayout(posts[index]);
        return _buildHorizontalLayout(posts[index]);
      },
    );
  }

  _buildVerticalLayout(Items item) {
    return Card(
        elevation: 4,
        child: Container(
          child: Row(
  ...
  _buildHorizontalLayout(Items item) {
    return Card(
        elevation: 4,
        child: Container(
          child: Row(
